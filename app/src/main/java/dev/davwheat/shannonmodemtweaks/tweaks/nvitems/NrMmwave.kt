...
class NrMmwave: NvItemTweak(), Parcelable {
  @IgnoredOnParcel
  override val name = "Enable n257, n258, n260 and n261 & DL256QAM"
  @IgnoredOnParcel
  ...
  override val nvItems: List<NvItem>
    get() =
        listOf(
            NvItem(id = "UECAPA_NR_RF_BAND_FR2_BM", value = 50266.toNvItemHexString(2)),
            ...
            NvItem(id = "UECAPA_NR_RF_BAND_FR2_BM_DS", value = 50266.toNvItemHexString(2)),
